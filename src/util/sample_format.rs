...
use crate::{global::{AUDIO_SUMMARY, VOLUME}, media::decoder::AudioFrame};
...
pub fn parse_audio_frame(frame: &mut AVFrame) -> AudioFrame {
    ...
    let pts_millis = 1000 * frame.pts * summary.time_base_num as i64 / summary.time_base_den as i64;
    ...
    let volume = VOLUME.load(Ordering::Acquire) as f32 / 50.0;
    let mut data = vec![];
